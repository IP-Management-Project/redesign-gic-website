  ...
  en: {
      ...
      primary: [
        {
          ...
          children: [
            ...
            { label: "Our Services", href: "/about/services", desc: "Discover the student services and support resources we offer." },
            { label: "Faculty & Staff", href: "/about/faculty-staff", desc: "Meet the faculty leaders and staff supporting the community." },
            { label: "Head Dep Message", href: "/about/message", desc: "Meet the faculty leaders and staff supporting the community." },
          ]
        },
        {
          label: "Programs",
        ...
        },
        {
          ...
          href: "/news-events",
          children: [
            { label: "Seminar & Events", href: "/news-events", desc: "Upcoming seminars, talks, and community events." },
            { label: "Academic Calendar", href: "/news-events/calendar", desc: "Important academic dates, deadlines, and key milestones." },
            { label: "Timetable", href: "/news-events/timetable", desc: "Class schedules and weekly timetables for students." },
          ]
        },
      ],
      menu: [
    ...
    pages: {
      about: {
        title: "About GIC",
        description:
          "Learn more about GIC, our history, and the services that support our community.",
        links: [
  ...
  km: {
    ...
    pages: {
      about: {
        title: "អំពី GIC",
        description:
          "ស្វែងយល់បន្ថែមអំពី GIC ប្រវត្តិសាស្ត្រ និងសេវាកម្មដែលគាំទ្រសហគមន៍របស់យើង។",
        links: [
