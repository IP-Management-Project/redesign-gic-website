...
export default function InternationalHeroModal({ isOpen, onClose }: SectionModalProps) {
  ...
  return (
    ...
    >
      <FieldsForm
        ...
        description="Update the hero badge, title, and introduction copy."
      />
    </SectionModal>
  );
}
