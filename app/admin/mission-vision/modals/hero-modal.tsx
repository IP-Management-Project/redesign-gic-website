...
const heroFields = [
  { key: "hero.badge", label: "Badge text", value: "" },
...
export default function MissionVisionHeroModal({ isOpen, onClose }: SectionModalProps) {
  ...
  return (
    <SectionModal
      title="Edit mission & vision hero"
      isOpen={isOpen}
      onClose={onClose}
      onSave={handleSave}
    ...
    >
      <FieldsForm
        ...
        description="Control the badge and headline that introduce the page."
      />
    </SectionModal>
  );
}
