...
import HistoryPageContent, {
  HistorySectionKey,
} from "@/app/about/history/page-content";
...
export default function HistoryGicAdminPage() {
  const [activeSection, setActiveSection] =
    React.useState<HistorySectionKey | null>(null);
  ...
  const parsedEntryIndex =
    activeSection && activeSection.startsWith("entry-")
      ...
      : null;
  const entryIndex =
    parsedEntryIndex !== null && !Number.isNaN(parsedEntryIndex)
      ? parsedEntryIndex
      : null;
