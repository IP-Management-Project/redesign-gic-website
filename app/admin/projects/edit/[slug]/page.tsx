...
import { usePageActions, useProjectBySlug } from "@/hooks/useProject";
...
export default function EditorClient() {
  ...
  // Hook Data
  const { data: page, isLoading: fetchingData } = useProjectBySlug(slug);
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const pluginCountdown = (await import("grapesjs-component-countdown"))
          .default;
          ...
          styleManager: {
            ...
            sectors: [
              ...
              },
              {
                name: "Border",
                open: false,
                buildProps: ["border", "border-radius", "border-color"],
              },
              {
                name: "Extra",
                open: false,
                buildProps: ["overflow", "z-index"],
              },
            ],
          },
          plugins: [
        ...
        editor.setComponents(
          page?.html || "<div><h1>Could not load content</h1></div>",
        );
