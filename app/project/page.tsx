...
import { ArrowUpRight, Rocket, Globe } from "lucide-react";
    ...
    <div className="py-20 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <section className="mb-20">
        ...
        <p className="max-w-2xl text-slate-500 text-lg font-medium leading-relaxed">
          Explore the full ecosystem of student-led initiatives, research
          outcomes, and technological prototypes developed within the GIC
          community.
        </p>
      </section>
                ...
                <div className="p-10 flex-grow flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-center pt-6 border-t border-divider/50">
                    <div className="flex -space-x-2">
                      <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center border-2 border-white dark:border-zinc-900">
                        <Rocket size={14} />
                      </div>
                      <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900 flex items-center justify-center border-2 border-white dark:border-zinc-900">
                        <Globe size={14} />
                      </div>
                    </div>
