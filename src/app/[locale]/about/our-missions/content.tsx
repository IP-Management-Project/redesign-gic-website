...
export function OurMissionsContent() {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
              ...
              <div className="border-l-4 border-blue-600 pl-6 md:pl-8 hover:border-blue-700 transition-colors duration-300">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-3 mb-3">
                    <mission.icon className="w-8 h-8 text-blue-600" strokeWidth={1.5} />
        ...
        >
          <p className="text-gray-600 text-lg">
            Committed to excellence in education and professional development
          </p>
        </motion.div>
      </div>
    </div>
