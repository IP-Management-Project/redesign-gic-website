...
interface PartnerSectionProps {
  ...
  universityPartners: Array<{ name: string; src: string, url: string }>;
  section?: string;
  container?: string;
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <Card className="md:col-span-8 border-none bg-default-100 overflow-hidden h-[400px]">
            ...
            <div className="absolute bottom-8 left-8 z-10 max-w-lg">
              ...
              <h3 className="text-3xl font-black text-foreground">Global Pathways</h3>
              <p className="mt-2 text-default-500 text-sm font-medium leading-relaxed">
                Expanding academic horizons through structured credit transfers and cross-continental research supervision.
              </p>
            </div>
          </Card>
          ...
          <Card className="md:col-span-4 border border-default-200/50 bg-default-50/20 backdrop-blur-sm shadow-none p-8 flex flex-col justify-center text-center">
            <div className="space-y-10">
              <div>
                ...
                <div className="text-xs font-mono font-bold uppercase tracking-widest text-default-400 mt-2">Active_Partners</div>
              </div>
              <div>
                <div className="text-5xl font-black text-indigo-500">EU/Asia</div>
                <div className="text-xs font-mono font-bold uppercase tracking-widest text-default-400 mt-2">Core_Regions</div>
              </div>
          ...
          <Card className="md:col-span-12 border border-default-200/50 bg-background shadow-none">
            <CardBody className="p-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-12 items-center">
                {universityPartners.map((p, index) => (
                  <a
                    key={`${p.name}-${index}`}
                    href={p.url}
                    target="_blank"
          ...
          <PathwayCard
            ...
            imgSrc="https://media.istockphoto.com/id/143071511/photo/graduates-with-diplomas-smiling-together.jpg?s=1024x1024&w=is&k=20&c=c50OPwsKWAgUNFd7ETdKxFLuxgA5wsTDHpnAsAD5UW4="
          />
          <PathwayCard
