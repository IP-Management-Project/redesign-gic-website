...
import { GraduationCap, Microscope, Briefcase, Code2, Globe, Layers, Award } from "lucide-react";
...
// 2. Main Section
export default function PillarsSection({ t, section = "", container = "" }: PillarsSectionProps) {
  return (
...
function PillarCard({ number, title, desc, icon: Icon, color }: any) {
