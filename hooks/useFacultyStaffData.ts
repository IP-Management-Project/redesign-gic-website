...
export type FacultyStaffData = {
  management: FacultyStaffMember[];
  lecturers: FacultyStaffMember[];
  researchers: FacultyStaffMember[];
  staff: FacultyStaffMember[];
};

const facultyStaffData: FacultyStaffData = {
  management: [
    {
      name: "Head Dep",
...
const getFacultyStaffData = async (): Promise<FacultyStaffData> => facultyStaffData;

export function useFacultyStaffData() {
  return useQuery({
    queryKey: ["facultyStaff"],
    queryFn: getFacultyStaffData,
